...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white; text-align: left;">institution Update</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="view1.php">Institution</a></li>
    ...
    <div class="row">
      ...
      <?php
      include 'phpback/dbconn.php';
      include 'phpback/upinst.php';
      ?>
      <section class="container">
          <header style="font-size: 20px;">Update Institution</header>
          <form action="phpback/update_institution_process.php" class="form" method="POST">
              <input type="hidden" name="institution_id" value="<?php echo $institution['id']; ?>">
              <div class="input-box">
                  <label>Institution Name</label>
                  <input style="font-size: 15px;" type="text" name="name" value="<?php echo $institution['name']; ?>">
              </div>
              <div class="input-box">
                  <label>Physical Address</label>
                  <input style="font-size: 15px;" type="text" name="physical_codes" value="<?php echo $institution['physical_codes']; ?>">
              </div>
              <div class="input-box">
                  <label>Email</label>
                  <input style="font-size: 15px;" type="text" name="email" value="<?php echo $institution['email']; ?>">
              </div>
              <div class="input-box">
                  <label>Phone</label>
                  <input style="font-size: 15px;" type="text" name="phone" value="<?php echo $institution['phone']; ?>">
              </div>
              <center>
