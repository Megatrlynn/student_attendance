...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white; text-align: left;">Lecturer Registration</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <div class="row">
      ...
      <section class="container">
        <header style="color: black; font-size: 20px;">Register Lecturer</header>
        <form action="phpback/insert_lecturer.php" class="form" method="POST">
            <div class="input-box">
                <label>Lecturer Name</label>
                <input style="font-size: 15px;" type="text" name="lecturer_name" placeholder="Enter name" required />
            </div>
            <div class="input-box">
            ...
            <div class="input-box">
                ...
                <input style="font-size: 15px;" type="number" name="phone" placeholder="Enter phone number" required />
            </div>
            <div class="input-box">
            ...
            <div class="input-box">
                ...
                <input style="font-size: 15px;" type="text" name="username" placeholder="Enter username" required />
            </div>
            <div class="input-box">
                <label>Lecturer password</label>
                <input style="font-size: 15px;" type="password" name="password" placeholder="Enter password" required />
            </div>
