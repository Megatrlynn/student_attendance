...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white; text-align: left;">student Update</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="view3.php">Students</a></li>
    ...
    <div class="row">
      ...
      <?php
      include 'phpback/dbconn.php';
      include 'phpback/upstudent.php';
        ?>
        <section class="container">
            <header style="font-size: 20px;">Update Student</header>
            <form action="phpback/update_student_process.php" class="form" method="POST">
                ...
                <div class="input-box">
                    ...
                    <select name="institution_id" id="institution" required style="border: none; color: #707070; width: 100%; height: 50px; border: 1px solid #ddd; display: flex; border-radius: 6px;">
                      ...
                      while ($row = $stmt_inst->fetch(PDO::FETCH_ASSOC)) {
                          $id = $row['id'];
                          $name = $row['name'];
                          $selected = ($id == $predefined_institution_id) ? "selected" : "";
