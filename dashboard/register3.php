...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white; text-align: left;">Student Registration</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <div class="row">
      ...
      <section class="container">
        <header style="color: black; font-size: 20px;">Register Student</header>
        <form action="phpback/insert_student.php" class="form" method="POST">
            <div class="input-box">
                <label>Student Name</label>
                <input style="font-size: 15px;" type="text" name="student_name" placeholder="Enter name" required />
            </div>
            <div class="input-box">
            ...
            <div class="input-box">
                <label>Reg. No</label>
                <input style="font-size: 15px;" type="text" name="reg_no" placeholder="Enter Reg. No" required />
            </div>
