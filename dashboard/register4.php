...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white; text-align: left;">Course Registration</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <div class="row">
      ...
      ?>
        <section class="container">
          <header style="color: black; font-size: 20px;">Register Course</header>
          <form action="phpback/insert_course.php" class="form" method="POST">
              <div class="input-box">
                  <label>Course Name</label>
                  <input style="font-size: 15px;" type="text" name="course_name" placeholder="Enter name" required />
              </div>
              <div class="input-box">
              ...
              <div class="input-box">
                  ...
                  <input style="font-size: 15px;" type="text" name="course_code" placeholder="Enter code" required />
              </div>
              <div class="creator-box">
                  ...
                  <div class="creator-option">
                      ...
                      <div class="creator">
                          <input type="radio" id="check-lecturer" name="created_by" value="Lecturer" />
                          <label for="check-lecturer">Lecturer</label>
                      </div>
                  </div>
              </div>
              <center>
