...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white; text-align: left;">Institution View</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <div class="row">
      <div class="col-md-12" id="maincont">
        <h1 style="color: white; margin-top: 5px; margin-bottom: -5px;">Available Institutions</h1>
              ...
              foreach ($institutions as $institution): ?> 
                ...
                <td data-th="Action">
                      <div class="container-button" style="width: auto; text-align: center; display: flex;">
                          <form action="phpback/delete_institution.php" method="post">
                          ...
                          <form action="update_institution.php" method="post">
                              <input type="hidden" name="institution_id" value="<?php echo $institution['id']; ?>">
