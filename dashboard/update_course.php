...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white; text-align: left;">course Update</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="view4.php">Courses</a></li>
    ...
    <div class="row">
      ...
      <?php
      include 'phpback/dbconn.php';
      include 'phpback/upcourse.php';
?>
<section class="container">
    <header style="font-size: 20px;">Update Course</header>
    <form action="phpback/update_course_process.php" class="form" method="POST">
        <input type="hidden" name="course_id" value="<?php echo $course['id']; ?>">
        <div class="input-box">
            <label>Course Name</label>
            <input style="font-size: 15px;" type="text" name="course_name" value="<?php echo $course['course_name']; ?>">
        </div>
        <div class="input-box">
        ...
        <div class="input-box">
            ...
            <input style="font-size: 15px;" type="text" name="course_code" value="<?php echo $course['course_code']; ?>">
        </div>
        <center>
