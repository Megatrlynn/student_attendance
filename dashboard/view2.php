...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color: white; text-align: left;">Lecturer View</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <div class="row">
      <div class="col-md-12" id="maincont">
        <h1 style="color: white; margin-top: 5px; margin-bottom: -5px;">Available Lecturers</h1>
          ...
          <table id="data-table" style="table-layout: auto;">
            <tbody>
              ...
              foreach ($institutions as $institution): ?> 
                ...
                <td data-th="Created Ay"><?php echo $institution['created_at']; ?></td>
                <td data-th="Updated Ay"><?php echo $institution['updated_at']; ?></td>
                <td data-th="Action">
                      <div class="container-button" style="width: auto; text-align: center; display: flex;">
                        <form action="phpback/delete_lecturer.php" method="post">
                          <input type="hidden" name="lecturer_id" value="<?php echo $institution['id']; ?>">
                        ...
                        <form action="add_course_lecturer.php" method="post">
                            <input type="hidden" name="lecturer_id" value="<?php echo $institution['id']; ?>">
